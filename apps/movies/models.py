...
class Actor(models.Model):
    ...
    description = models.TextField("Описание")
    image = models.ImageField("Изображение", upload_to="movies/actors/")
...
class Movie(models.Model):
    ...
    budget = models.PositiveSmallIntegerField("Бюджет", default=0, help_text="указывать сумму в долларах США")
...
class MovieShots(models.Model):
        ...
        description = models.TextField("Описание")
        image = models.ImageField("Изображение", upload_to="movies/movie_shots/")
